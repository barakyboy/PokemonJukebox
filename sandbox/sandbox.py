...
def main():
    ...
    # song queue
    queue = Queue()
    LINK = 'https://www.youtube.com/watch?v=iWMN91gMD_4&ab_channel=JamesAlbert'
    ...
    audio = AudioSegment.from_file("C:\\Users\\uriba\\Desktop\\musicmon\\assets\\MUS\\mus7.mp3", format="mp4")
